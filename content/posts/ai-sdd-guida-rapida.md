...
- **Spec in linguaggio naturale** — requisiti e scenari scritti in Markdown, che un **agente AI** legge ed esegue. Vedi gli esempi pratici con [Spec Kit](/ai-spec-kit-book-api/) e [OpenSpec](/ai-openspec-book-api/).
