...
Vedi [Ollama LLM Locali](/learning/posts/ai-ollama-llm-locali/) per i dettagli.
...
I dati emersi nell'articolo sulla [comparativa](/learning/posts/ai-ollama-llm-locali/) dei modelli sono stati ricavati con un metodo fisso, per essere sicuro di non pubblicare cose imprecise: stesso identico progetto, stesse domande, stesso ordine, sessione pulita a ogni run.
...
Se volete saperne di piu  sul funzionamento di opencode ho scritto questi articoli [Opencode](/learning/posts/ai-opencode/) e [Agents.md](/learning/posts/ai-agents-md/) .
